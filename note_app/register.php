...
if (isset($_POST['register']) && isset($_POST['reg_email']) && isset($_POST['reg_password']) && isset($_POST['reg_password2'])) {
    ...
    if ($pass1 !== $pass2) {
        ...
        if ($check_res->num_rows > 0) {
            ...
            // Đăng nhập luôn
            require_once 'send_verification.php'; // Gọi hàm gửi email

            if (sendVerificationEmail($email, $token)) {
                $reg_success = "Vui lòng kiểm tra email để xác nhận tài khoản.";
            } else {
                $reg_error = "Không thể gửi email xác nhận. Vui lòng thử lại.";
            }
